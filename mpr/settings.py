...
SECRET_KEY = 'django-insecure-2ll2n32iswb%n@tzo#fxzcz5xxg^@0c6w671k#@z+&6zzzd#gl'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'irctc',      # Replace with your database name
        'USER': 'irctc',          # Replace with your database user
